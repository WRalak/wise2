  ...
  return (
    <header className="relative  w-full h-[350px]"> {/* Increased height */}
      ...
      <div className="absolute inset-0 bg-black bg-opacity-30 flex flex-col items-center justify-center text-center px-6">
        {/* Text */}
        <p className="text-white text-sm sm:text-xs lg:text-sm font-medium mb-4 leading-relaxed">
        ...
        <div className="flex flex-wrap justify-center gap-4 ">
          {/* Blue Button */}
          <button className="bg-blue-500 text-white px-4 py-2 rounded-xl  flex items-center gap-2 text-sm lg:text-base">
            Find Companion
            <MdArrowOutward size={15} />
          </button>

          {/* White Button */}
          <button className="bg-white text-blue-800 border-1 border-blue-500 px-4 py-2 rounded-xl flex items-center gap-2 text-sm lg:text-base">
